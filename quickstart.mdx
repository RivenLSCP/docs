...
1. **Install from Chrome Web Store**: Add the Sera AI Data Extension from the [Chrome Web Store](https://chrome.google.com/webstore)
...
<CardGroup>
  ...
  >
    Integrate Sera into your applications
  </Card>
</CardGroup>
