...
description: 'Monetize your AI data assets and earn SERA tokens through our decentralized marketplace'
---
...
subscription = await market.create_subscription(
    asset_id="0x...",
    config={
        "monthly_price": 100,  # SERA per month
...
print(f"""
Performance Metrics:
- Total Revenue: {stats.revenue} SERA
...
<CardGroup cols={2}>
  <Card title="Asset Dashboard" icon="gauge">
    [Manage Assets](https://owner.sera.xyz)
  </Card>
  <Card title="Revenue Analytics" icon="chart-pie">
    [Track Earnings](https://owner.sera.xyz/analytics)
  </Card>
  <Card title="Owner Network" icon="building-user">
    [Owner Forum](https://forum.sera.xyz/owners)
  </Card>
  <Card title="Enterprise Support" icon="headset">
    [Priority Support](https://enterprise.sera.xyz)
  </Card>
</CardGroup>

<Note>
Looking to maximize your asset revenue? Schedule a [free consultation](https://sera.xyz/owner-consult) with our monetization experts.
</Note>