...
```mermaid
graph TD
    A[Vector Data] --> B[Kyne Vector DB]
...
<Note>
Want to earn tokens by contributing vector data? Join our [Discord](https://discord.gg/kyne) to learn more about data contribution opportunities.
</Note>
