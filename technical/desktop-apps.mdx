...
The Sera desktop app is your gateway to the AI marketplace, allowing you to:
...
<Steps>
  1. **Download**
     Get the app from our [official release page](https://sera.xyz/desktop)

  2. **Wallet Setup**
     ```bash
     # Import existing SUI wallet
     sera-desktop wallet import --private-key=0x...
     
     # Or create new wallet
     sera-desktop wallet create
     ```

  3. **Configure Storage**
     ```bash
     # Set storage preferences
     sera-desktop storage configure \
       --min-nodes=7 \
       --epochs=12 \
       --redundancy=2
     ```
...
<CardGroup cols={2}>
  ...
  <Card title="Updates" icon="download">
    [Latest Release](https://sera.xyz/desktop)
  </Card>
</CardGroup>

<Note>
Want to earn passive income from AI storage? Join our [Discord](https://discord.gg/sera) to learn about running storage nodes.
</Note> 