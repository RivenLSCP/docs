...
description: "How Kyne combines SUI blockchain and Walrus storage to power the AI data marketplace"
---
...
```mermaid
graph TD
    A[Data Contributors] --> B[Kyne Marketplace]
    C[AI Developers] --> B
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub" icon="github">
    [Source Code](https://github.com/kyne)
  </Card>
  <Card title="Support" icon="headset">
    [Technical Support](mailto:support@kyne.xyz)
  </Card>
</CardGroup>

<Note>
Want to start earning from AI data? Join our [Discord](https://discord.gg/kyne) to learn more about contribution opportunities.
</Note> 
